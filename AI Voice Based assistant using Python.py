...
def run_alexa():
    ...
    try:
        ...
        if 'hello' in command:
            ...
            location, locate area on map, open different websites like instagram, youtube,gmail, git hub, swayam, stack 
            ...
            engine_talk('''i can play songs on youtube , tell you a joke, search on wikipedia, tell date and time,find
             your location, locate area on map, open different websites like insta gram, youtube,gmail, git hub, swayam
        ...
        elif 'open swayam' in command:
            print('opening swayam...')
            engine_talk('opening swayam...')
            webbrowser.open_new('https://swayam.gov.in/')
        elif 'bye' in command:
...
print('\n')
print("hello, i am mini alexa how i help you ??")
